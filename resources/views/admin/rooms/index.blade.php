                    ...
                    <table class="rt-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="rt-area">{{ number_format($type->width * $type->height, 1) }}</span></td>
                                <td>
                                    <div class="rt-beds">
                                ...
                                <td><span class="rt-price-hour">{{ number_format($type->hourly_price, 0, ',', '.') }}₫</span></td>
                                <td><span class="rt-price-day">{{ number_format($type->daily_price, 0, ',', '.') }}₫</span></td>
                                <td><div class="rt-quantity">{{ $type->rooms_count }}</div></td>
                                <td>
                                    <div class="rt-actions">
                                        <a href="{{ route('admin.room-types.index', ['id' => $type->id]) }}" class="rt-btn-action view" title="Xem chi tiết">
                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                        </a>
                                        <a href="{{ route('admin.rooms.edit', $type->id) }}" class="rt-btn-action edit" title="Chỉnh sửa">
                                        ...
                                        <form action="{{ route('admin.rooms.destroy', $type->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa loại phòng này?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="rt-btn-action delete" title="Xóa" style="border:none; cursor:pointer;">
