    ...
    public function run(): void
    {
        ...
        $tickets = [
            [
                ...
                'status'                => 'in_progress',
                'repair_cost'           => 850000,
                'reported_by_staff_id'  => 2,    // Lễ tân báo cáo
                'technician_id'         => 3,    // Kỹ thuật viên phụ trách
            ...
            [
                ...
                'room_id'               => 8,
                'equipment_id'          => null,  // Chưa xác định
