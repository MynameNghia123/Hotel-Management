            ...
            <div class="st-container">
                <div class="st-header">
                    <div>
                        ...
                        <p class="st-subtitle">Trang quản lý nhóm dịch vụ (ServiceGroups) cho hệ thống khách sạn Urban Luxe.</p>
                    </div>
                ...
                <div class="st-table-wrapper">
                    <table class="st-table">
                        ...
                        <tbody>
                            @php
                                $groups = [
                                    ['id' => '1', 'name' => 'Dịch vụ ăn uống'],
                                    ['id' => '2', 'name' => 'Dịch vụ Spa & Wellness'],
                                    ['id' => '3', 'name' => 'Dịch vụ giặt ủi'],
                                    ['id' => '4', 'name' => 'Dịch vụ đưa đón'],
                                    ['id' => '5', 'name' => 'Dịch vụ giải trí'],
                                ];
                            @endphp
                            ...
                            <tr>
                                ...
                                <td class="st-name-main">{{ $item['name'] }}</td>
                                <td>
                                    <div class="st-actions">
                                        <button class="st-btn-action edit" title="Chỉnh sửa">
                                        ...
                                        <button class="st-btn-action delete" title="Xóa">
