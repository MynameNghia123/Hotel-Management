                    ...
                    <table class="am-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 100px;">BIỂU TƯỢNG (ICON)</th>
                        ...
                        <tbody>
                            @php
                                $amenities = [
                                    ['id' => '1', 'name' => 'Wifi miễn phí tốc độ cao', 'icon' => 'wifi'],
                                    ['id' => '2', 'name' => 'Bộ lanh vệ sinh', 'icon' => 'bath'],
                                    ['id' => '3', 'name' => 'Điều hòa 2 chiều', 'icon' => 'wind'],
                                    ['id' => '4', 'name' => 'Bãi đỗ xe riêng', 'icon' => 'truck'],
                                    ['id' => '5', 'name' => 'Phòng Gym hiện đại', 'icon' => 'activity'],
                                    ['id' => '6', 'name' => 'Dịch vụ Spa & Massage', 'icon' => 'droplet'],
                                ];
                            @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="am-icon-box">
                                        @if($item['icon'] == 'wifi') <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.55a11 11 0 0114.08 0"></path><path d="M1.42 9a16 16 0 0121.16 0"></path><path d="M8.59 16a6 6 0 016.82 0"></path><line x1="12" y1="20" x2="12.01" y2="20"></line></svg>
                                        @elseif($item['icon'] == 'bath') <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6 6.5 3.5a1.5 1.5 0 0 0-2.12 2.12L6 8"></path><path d="M2 19.4V14a3 3 0 0 1 3-3h14a3 3 0 0 1 3 3v5.4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2Z"></path></svg>
                                        @elseif($item['icon'] == 'wind') <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2"></path><path d="M9.6 4.6A2 2 0 1 1 11 8H2"></path><path d="M12.6 19.4A2 2 0 1 0 14 16H2"></path></svg>
                                        @elseif($item['icon'] == 'truck') <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 17h4V5H2v12h3m10 0h4v-7h-4v7ZM5 17a2 2 0 1 0 4 0 2 2 0 1 0-4 0Zm10 0a2 2 0 1 0 4 0 2 2 0 1 0-4 0Z"></path></svg>
                                        @elseif($item['icon'] == 'activity') <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                                        @elseif($item['icon'] == 'droplet') <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"></path></svg>
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="am-actions">
                                        <button class="am-btn-action edit" title="Chỉnh sửa">
                                        ...
                                        <button class="am-btn-action delete" title="Xóa">
