    ...
    <div style="display:flex; height:100vh; background:#f5f6fa;">
        ...
        <main style="flex:1; display:flex; flex-direction:column; overflow:hidden;">
            ...
            <header
                ...
                <div
                    style="display:flex; align-items:center; gap:8px; font-size:14px; font-weight:600; color:#1e293b; cursor:pointer;">
                ...
                <div style="display:flex; align-items:center; gap:18px;">
                    <div style="text-align: right;">
                        <span style="font-size:10px; font-weight:700; color:#94a3b8; text-transform:uppercase;">Ngày làm
                            việc</span>
                    ...
                    <div
                        style="width:36px; height:36px; border-radius:10px; background:#dcfce7; display:flex; align-items:center; justify-content:center; overflow:hidden;">
            ...
            <div style="flex:1; overflow-y:auto; padding:32px; display:flex; flex-direction:column; background:#f8fafc;">
                ...
                @if(session('error'))
                    <div
                        style="background: #fee2e2; color: #b91c1c; padding: 16px; border-radius: 12px; margin-bottom: 24px; border: 1px solid #fecaca; display: flex; align-items: center; gap: 12px; font-weight: 600;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="am-container">
                    <div class="am-header">
                        ...
                        <a href="{{ route('admin.amenities.create') }}" class="am-btn-primary"
                                        ...
                                        <td style="text-align: center;">
                                            @if($item->icon)
                                                <span class="material-symbols-outlined"
                                                    style="vertical-align: middle; color: #475569; font-size: 20px;">
                                                    {{ strtolower(trim($item->icon)) }}
                                                </span>
                                            @else
                                        ...
                                        <td>
                                            <div class="am-actions">
                                                <a href="{{ route('admin.amenities.edit', $item->id) }}"
                                                    class="am-btn-action edit" title="Chỉnh sửa"
                                                ...
                                                <form action="{{ route('admin.amenities.destroy', $item->id) }}" method="POST"
                                                    style="display:inline;"
                                                    onsubmit="return confirm('Bạn có chắc chắn muốn xoá tiện ích này?');">
                                                    @csrf
                                                    @method('DELETE')
