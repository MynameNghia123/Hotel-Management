...
@section('title', 'Thêm thiết bị | Urban Luxe Admin')
...
<div class="am-layout">
    ...
    <main class="am-main">
        ...
        <div class="am-content-area">
            <div class="am-card">
                <h2 class="am-card-title">Thêm thiết bị mới</h2>
                <form action="{{ route('admin.equipment.store') }}" method="POST">
                    ...
                    <div class="am-form-group">
                        ...
                        <input type="text" name="name" class="am-form-input" value="{{ old('name') }}" placeholder="Vd: Điều hoà Daikin, Tivi Samsung...">
                    ...
                    <div class="am-form-group" style="margin-top:16px;">
                        ...
                        <input type="number" name="import_price" class="am-form-input" value="{{ old('import_price') }}" placeholder="Vd: 5000000" min="0">
                    ...
                    <div class="am-actions">
                        ...
                        <button type="submit" class="am-btn-submit">Lưu thiết bị</button>
                    </div>
                </form>
            </div>
        </div>
